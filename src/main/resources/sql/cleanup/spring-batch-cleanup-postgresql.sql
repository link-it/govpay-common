-- =============================================================================
-- Svecchiamento dei metadati Spring Batch -- PostgreSQL
--
...
-- nel letterale di data: qui TIMESTAMP '@@CUTOFF@@'
-- =============================================================================
...
WHERE STEP_EXECUTION_ID IN (
    ...
    WHERE COALESCE(je.END_TIME, je.START_TIME, je.CREATE_TIME) < TIMESTAMP '@@CUTOFF@@'
);
...
WHERE JOB_EXECUTION_ID IN (
    ...
    WHERE COALESCE(END_TIME, START_TIME, CREATE_TIME) < TIMESTAMP '@@CUTOFF@@'
);

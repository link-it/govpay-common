-- =============================================================================
-- Svecchiamento dei metadati Spring Batch -- Oracle
--
...
-- nel letterale di data: qui TO_TIMESTAMP('@@CUTOFF@@', 'YYYY-MM-DD HH24:MI:SS')
-- =============================================================================
...
WHERE STEP_EXECUTION_ID IN (
    ...
    WHERE COALESCE(je.END_TIME, je.START_TIME, je.CREATE_TIME) < TO_TIMESTAMP('@@CUTOFF@@', 'YYYY-MM-DD HH24:MI:SS')
);
...
WHERE JOB_EXECUTION_ID IN (
    ...
    WHERE COALESCE(END_TIME, START_TIME, CREATE_TIME) < TO_TIMESTAMP('@@CUTOFF@@', 'YYYY-MM-DD HH24:MI:SS')
);

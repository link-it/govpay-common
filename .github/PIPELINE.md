...
3. Verifica che il projectKey sia: `link-it_govpay-common`
...
```markdown
[![Java CI with Maven](https://github.com/link-it/govpay-common/actions/workflows/maven.yml/badge.svg)](https://github.com/link-it/govpay-common/actions/workflows/maven.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=link-it_govpay-common&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=link-it_govpay-common)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=link-it_govpay-common&metric=coverage)](https://sonarcloud.io/summary/new_code?id=link-it_govpay-common)
```

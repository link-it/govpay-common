-- =============================================================================
-- Svecchiamento dei metadati Spring Batch -- SQL Server
--
...
-- nel letterale di data: qui CONVERT(DATETIME2, '@@CUTOFF@@', 120)
-- =============================================================================
...
WHERE STEP_EXECUTION_ID IN (
    ...
    WHERE COALESCE(je.END_TIME, je.START_TIME, je.CREATE_TIME) < CONVERT(DATETIME2, '@@CUTOFF@@', 120)
);
...
WHERE JOB_EXECUTION_ID IN (
    ...
    WHERE COALESCE(END_TIME, START_TIME, CREATE_TIME) < CONVERT(DATETIME2, '@@CUTOFF@@', 120)
);
